...
function new_mood (mood: number) {
    if (mood == zMOOD_SNORING) {
        set_mood(zEYES_SHUT, zMOUTH_FLAT, zEYES_SHUT, zMOUTH_OPEN, 2000, 2000, 1)
    } else if (mood == zMOOD_ASLEEP) {
        set_mood(zEYES_SHUT, zMOUTH_FLAT, zEYES_SHUT, zMOUTH_HMMM, 3000, 500, 1)
    } else if (mood == zMOOD_BORED) {
        set_mood(zEYES_OPEN, zMOUTH_FLAT, zEYES_SHUT, zMOUTH_FLAT, 3000, 500, 4)
    } else if (mood == zMOOD_HAPPY) {
        set_mood(zEYES_OPEN, zMOUTH_GRIN, zEYES_SHUT, zMOUTH_GRIN, 1000, 200, 3)
    } else if (mood == zMOOD_SAD) {
        set_mood(zEYES_SAD, zMOUTH_SULK, zEYES_SHUT, zMOUTH_SULK, 4000, 500, 2)
    } else if (mood == zMOOD_ANGRY) {
        set_mood(zEYES_MAD, zMOUTH_HMMM, zEYES_MAD, zMOUTH_SHOUT, 2000, 800, 2)
    } else if (mood == zMOOD_GOSH) {
        set_mood(zEYES_POP, zMOUTH_OPEN, zEYES_POP, zMOUTH_OPEN, 1000, 1000, 1)
    } else if (mood == zMOOD_SHIVER) {
        set_mood(zEYES_LEFT, zMOUTH_SHOUT, zEYES_RIGHT, zMOUTH_OPEN, 200, 200, 1)
